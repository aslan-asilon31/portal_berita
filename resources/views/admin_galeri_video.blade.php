        ...
        <div class="row">
          <div class="col-lg-12 d-flex "  >
              ...
              <div class="col-lg-2" style="width: 100%;">
                <a href="{{ route('admin-galeri-video.create') }}" class="btn btn-purple bg-purple"> <i class="fa fa-plus"></i> Buat @yield('title')</a>
              </div>
                    ...
                    <tbody>
                      @forelse($galeri_video as $kg)
                        ...
                        <td>
                                ...
                                @else
                                    <a href="{{ $kg->video }}" target="_blank">Watch Video</a>
                                @endif
                            ...
                            <td> 
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('admin-galeri-video.destroy', $kg->id) }}" method="POST">
                                    <a href="{{ route('admin-galeri-video.edit', $kg->id) }}" class="btn btn-warning btn-sm text-white"><i class="fa fa-edit"></i></a> 
