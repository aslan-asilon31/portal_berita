        ...
        <div class="row">
          <div class="col-lg-12 d-flex "  >
              ...
              <div class="col-lg-2" style="width: 100%;">
                <a href="{{ route('admin-infografis.create') }}" class="btn btn-purple bg-purple"> <i class="fa fa-plus"></i> Buat @yield('title')</a>
              </div>
                      ...
                      @forelse($infografis as $kg)
                        <tr id="tampil-menu">
                          ...
                          @endif 
                            ...
                            <td> 
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('admin-infografis.destroy', $kg->id) }}" method="POST">
                                    <a href="{{ route('admin-infografis.edit', $kg->id) }}" class="btn btn-warning btn-sm text-white"><i class="fa fa-edit"></i></a> 
                                    @csrf
                                    @method('DELETE')
