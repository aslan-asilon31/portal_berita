        ...
        <div class="row">
          <div class="col-lg-12 d-flex "  >
              ...
              <div class="col-lg-2" style="width: 100%;">
                <a href="{{ route('admin-galeri-foto.create') }}" class="btn btn-purple bg-purple"> <i class="fa fa-plus"></i> Buat @yield('title')</a>
              </div>
              ...
              <div class="card-body" id="card-table" style="overflow-x: auto; overflow-y: auto; max-height: 400px;">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      @forelse($galeri_fotos as $kg)
                        <tr id="tampil-menu">
                          @if(empty($kg->image) || is_null($kg->image))
                            <td><img src="{{ asset('no-image.jpg') }}" class="rounded" style="width: 150px"></td>
                            @else 
                            <td><img src="{{ asset('PORTAL-BERITA-ASSET/galeri__foto/' . $kg->image) }}" class="rounded" style="width: 150px"></td>
                          @endif 
                            <td>{!! $kg->name !!}</td>
                            ...
                            <td> 
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('admin-galeri-foto.destroy', $kg->id) }}" method="POST">
                                    <a href="{{ route('admin-galeri-foto.edit', $kg->id) }}" class="btn btn-warning btn-sm text-white"><i class="fa fa-edit"></i></a> 
