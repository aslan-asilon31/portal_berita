        ...
        <div class="row">
          <div class="col-lg-12 d-flex "  >
              ...
              <div class="col-lg-2" style="width: 100%;">
                <a href="{{route('admin-kegiatan.create')}}" class="btn btn-purple bg-purple"> <i class="fa fa-plus"></i> Buat @yield('title')</a>
              </div>

              </div>
              <!-- /.card-header -->
              <div class="card-body" id="card-table" style="overflow-x: auto; overflow-y: auto; max-height: 400px;max-width: 1400px;">
                    ...
                    <tbody>
                      @forelse($kegiatan as $kg)
                        <tr id="tampil-menu">
                            ...
                            <td>{{ $kg->end_date }}</td>
                            <td> 
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('admin-kegiatan.destroy', $kg->id) }}" method="POST">
                                    <a href="{{ route('admin-kegiatan.edit', $kg->id) }}" class="btn btn-warning btn-sm text-white"><i class="fa fa-edit"></i></a> 
