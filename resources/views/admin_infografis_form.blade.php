...
@section('title','infografis create')
@section('content')
...
@include('sweetalert::alert')
    ...
    <section class="content pb-3 ">
      ...
      <div class="row" >
            <form action="{{route('admin-infografis.store')}}" method="POST" enctype="multipart/form-data" style="width:900px;" class="">
            @csrf
                    ...
                    <div class="card-body scrollable-card">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <textarea id="agenda_name" name="agenda_name" value="{{ old('agenda_name') }}" class="form-control @error('agenda_name') is-invalid @enderror">
