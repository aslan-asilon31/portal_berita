                    ...
                    <div class="card-body scrollable-card">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Detail agenda</label>
                                    <textarea id="agenda_detail" name="agenda_detail" class="form-control @error('agenda_detail') is-invalid @enderror">
                                        {{ old('desc2', $news->desc2) }}
                                    </textarea>
                                ...
                                @if($news->image)
                                    <div class="form-group">
                                        ...
                                        <div class="mt-2" style="width:100%;">
                                            <img src="{{ Storage::url('public/informasi_agenda/' . $news->image) }}" class="rounded" style="width: 150px">
                                        </div>
                                    </div>
                                @else
                                    <div class="form-group">
