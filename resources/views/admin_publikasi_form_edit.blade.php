...
@include('sweetalert::alert')
    ...
    <section class="content pb-3 ">
      ...
      <div class="row" >
            <form action="{{route('admin-publikasi.update', $news->id)}}" method="POST" enctype="multipart/form-data" style="width:1100px;" class="">
            @csrf
            @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="publikasi_status" id="publikasi_status" class="form-control @error('publikasi_status') is-invalid @enderror">
                            ...
                            <div class="col-lg-4">
                                @if($news->file)
                                    <div class="form-group">
                                        <label for="image">Masukan File</label>
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" value="{{ old('file', $news->file) }}" id="pdf_file" name="pdf_file" accept=".pdf">
                                                <label class="custom-file-label" for="file">Choose file</label>
                                            </div>
                                        </div>
                                        <div class="mt-2" style="width:100%;">
                                        isi file nya ada.  klik browse/choose file untuk mengganti file baru
                                        </div>
                                    </div>
                                @else
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="image" name="pdf_file" accept=".pdf">
