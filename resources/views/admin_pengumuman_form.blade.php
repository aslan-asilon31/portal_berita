...
@section('title','Pengumuman Create')
@section('content')
...
@include('sweetalert::alert')
    ...
    <section class="content pb-3 ">
      ...
      <div class="row" >
            <form action="{{route('admin-pengumuman.store')}}" method="POST" enctype="multipart/form-data" style="width:900px;" class="">
            @csrf
                    ...
                    <div class="card-body scrollable-card">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <textarea id="pengumuman_name" name="pengumuman_name" value="{{ old('pengumuman_name') }}" class="form-control @error('pengumuman_name') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="pengumuman_detail" name="pengumuman_detail" value="{{ old('pengumuman_detail') }}" class="form-control @error('pengumuman_detail') is-invalid @enderror">
                                  Place <em>some</em> <u>text</u> <strong>here</strong>
                                </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="pengumuman_status" id="agenda_status"  class="form-control @error('agenda_status') is-invalid @enderror">
  ...
  <script src="{{ asset('adminlte/plugins/daterangepicker/daterangepicker.js') }}"></script>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#pengumuman_name').summernote()
        $('#pengumuman_detail').summernote()
