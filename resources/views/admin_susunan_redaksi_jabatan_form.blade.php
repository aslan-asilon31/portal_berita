...
@include('sweetalert::alert')
    ...
    <section class="content pb-3 ">
      ...
      <div class="row" >
            <form action="{{route('admin-susunan-redaksi-jabatan-store')}}" method="POST" enctype="multipart/form-data" style="width:900px;" class="">
            @csrf
                    ...
                    <div class="card-body scrollable-card">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukan Nama Jabatan" name="jabatan" id="" value="{{ old('jabatan') }}" class="form-control @error('jabatan') is-invalid @enderror" >
