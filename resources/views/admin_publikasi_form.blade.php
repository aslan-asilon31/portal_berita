...
@section('title','Publikasi Create')
@section('content')
...
@include('sweetalert::alert')
    ...
    <section class="content pb-3 ">
      ...
      <div class="row" >
            <form action="{{route('admin-publikasi.store')}}" method="POST" enctype="multipart/form-data" style="width:900px;" class="">
            @csrf
                    ...
                    <div class="card-body scrollable-card">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group" style="display:block !important;">
                                ...
                                <textarea id="publikasi_name" name="publikasi_name" value="{{ old('publikasi_name') }}" class="form-control @error('publikasi_name') is-invalid @enderror">
